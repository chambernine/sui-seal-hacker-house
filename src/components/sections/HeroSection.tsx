    ...
    >
      ...
      <div className="relative px-6 py-24 sm:px-12 sm:py-32 lg:px-16 flex flex-col items-center text-center">
        ...
        >
          ...
          <span className="text-primary">Blockchain Privacy</span>
        </motion.h1>
        <motion.p
          initial={{ y: 20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
        ...
        >
          Subscribe to exclusive photo albums with encrypted content on the Sui
          blockchain. Create your own fan base and monetize your content
          securely.
        </motion.p>
        <motion.div
          initial={{ y: 20, opacity: 0 }}
